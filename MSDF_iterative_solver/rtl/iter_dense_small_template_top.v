...
// Template-ROM-integrated dense small top.
//
// Compared with iter_dense_small_sched_top, this top no longer requires the
// testbench to hand-drive scheduler buses. Fixed-degree template payloads are
// loaded from a packed memory image, unpacked, then consumed by the scheduler.

module iter_dense_small_template_top #(
    ...
    iter_fixed_degree_template_rom #(
