...
module iter_parallel_online_adder_4 #(
    ...
    iter_parallel_online_adder #(.bit_width(bit_width)) poa_0_0 (
        .i_x_p(i_x0_p), .i_x_n(i_x0_n),
        .i_y_p(i_x1_p), .i_y_n(i_x1_n),
        .i_c_p(1'b0), .i_c_n(1'b0),
        .o_z_p(t0_0_p), .o_z_n(t0_0_n),
        .o_c_p(c0_0_p), .o_c_n(c0_0_n)
    );

    iter_parallel_online_adder #(.bit_width(bit_width)) poa_0_1 (
        .i_x_p(i_x2_p), .i_x_n(i_x2_n),
        .i_y_p(i_x3_p), .i_y_n(i_x3_n),
        .i_c_p(1'b0), .i_c_n(1'b0),
        .o_z_p(t0_1_p), .o_z_n(t0_1_n),
        .o_c_p(c0_1_p), .o_c_n(c0_1_n)
    );
    ...
    iter_parallel_online_adder #(.bit_width(bit_width + 1)) poa_1 (
        .i_x_p(t1_0_p), .i_x_n(t1_0_n),
        .i_y_p(t1_1_p), .i_y_n(t1_1_n),
        .i_c_p(1'b0), .i_c_n(1'b0),
